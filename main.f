     ...
     & FFORCEB=14,FFORCEI=15,TSTEP,NSTEPS,NBAND0,I,J,INFO,
     & FCOHSTRESS=16
          INTEGER :: LOCALDOFS(6)
     ...
     & ALL(UKNOWNDOFS(1:NUKNOWN) .NE. I)) THEN
          ...
          FOUTPUT = TRIM(FINPUT)//'_coh-stress.txt'
          OPEN(UNIT=FCOHSTRESS,FILE=FOUTPUT)
...
C Composite
     ...
     & FIE,FSEP,FDISPI,FFORCEI,FCOHSTRESS)
