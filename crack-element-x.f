     ...
     & TREF,TTYPE,TTOP,TMID,TBOTTOM,ALPHAX,ALPHAY,VB,
...
C Generate temperature fields
          IF(TTYPE .EQ. 0) THEN !Constant temperature
            CALL CONSTANTTEMP(TTOP,TEMPERATURE,NCOMPDOFS)
...
C Translate KBBTILDE to KCOMPBEAM
     ...
     & UB,KBBTILDE,TEMPERATURE,FGLOBAL,FBTILDE,TL,TNL)
